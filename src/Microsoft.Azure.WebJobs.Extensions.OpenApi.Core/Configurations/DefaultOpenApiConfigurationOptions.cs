...
namespace Microsoft.Azure.WebJobs.Extensions.OpenApi.Core.Configurations
{
    ...
    public class DefaultOpenApiConfigurationOptions : IOpenApiConfigurationOptions
    {
        ...
        {
            var development = bool.TryParse(Environment.GetEnvironmentVariable(ForceHttpKey), out var result) && result;
        ...
        {
            var development = bool.TryParse(Environment.GetEnvironmentVariable(ForceHttpsKey), out var result) && result;
