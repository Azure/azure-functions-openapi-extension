...
namespace Microsoft.Azure.WebJobs.Extensions.OpenApi.Core.Abstractions
{
    ...
    public interface IDocumentHelper
    {
        ...
        OpenApiRequestBody GetOpenApiRequestBody(MethodInfo element, NamingStrategy namingStrategy, VisitorCollection collection, OpenApiNamespaceType namespaceType, OpenApiVersionType version = OpenApiVersionType.V2);
        ...
        OpenApiResponses GetOpenApiResponseBody(MethodInfo element, NamingStrategy namingStrategy = null, OpenApiNamespaceType namespaceType = OpenApiNamespaceType.ShortName);
        ...
        /// <param name="version">OpenAPI spec version.</param>
        /// <returns><see cref="OpenApiResponses"/> instance.</returns>
        OpenApiResponses GetOpenApiResponses(MethodInfo element, NamingStrategy namingStrategy, OpenApiNamespaceType namespaceType, VisitorCollection collection, OpenApiVersionType version = OpenApiVersionType.V2);
        ...
        Dictionary<string, OpenApiSchema> GetOpenApiSchemas(List<MethodInfo> elements, NamingStrategy namingStrategy, OpenApiNamespaceType namespaceType, VisitorCollection collection);
