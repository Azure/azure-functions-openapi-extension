...
{
    public class Get_ApplicationJson_ExceptionObject_HttpTrigger
    {
        [FunctionName(nameof(Get_ApplicationJson_ExceptionObject_HttpTrigger))]
        [OpenApiOperation(operationId: nameof(Get_ApplicationJson_ExceptionObject_HttpTrigger.Get_ApplicationJson_Exception), tags: new[] { "exception" })]
