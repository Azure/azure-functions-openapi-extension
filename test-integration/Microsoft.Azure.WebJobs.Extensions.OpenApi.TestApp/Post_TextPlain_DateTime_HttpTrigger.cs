...
namespace Microsoft.Azure.WebJobs.Extensions.OpenApi.TestApp
{
    ...
    {
        [FunctionName(nameof(Post_TextPlain_DateTime_HttpTrigger.Post_TextPlain_DateTime))]
        ...
        [FunctionName(nameof(Post_TextPlain_DateTime_HttpTrigger.Post_TextPlain_DateTimeOffset))]
        [OpenApiOperation(operationId: nameof(Post_TextPlain_DateTime_HttpTrigger.Post_TextPlain_DateTimeOffset), tags: new[] { "datetime" })]
        [OpenApiRequestBody(contentType: "text/plain", bodyType: typeof(DateTime), Required = true, Description = "The OK response")]
