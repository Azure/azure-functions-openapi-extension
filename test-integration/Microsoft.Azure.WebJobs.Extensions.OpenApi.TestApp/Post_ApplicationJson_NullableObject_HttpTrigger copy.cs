...
namespace Microsoft.Azure.WebJobs.Extensions.OpenApi.TestApp
{
    public static class Post_ApplicationJson_NullableObject_HttpTrigger
    {
        ...
        [OpenApiRequestBody(verb: "GET",contentType: "text/plain", bodyType: typeof(bool?), Required = true, Description = "The OK response")]
        [OpenApiResponseWithBody(verb: "GET",statusCode: HttpStatusCode.OK, contentType: "application/json", bodyType: typeof(NullableObjectModel), Description = "The OK response")]
        ...
        [OpenApiRequestBody(verb: "GET",contentType: "text/plain", bodyType: typeof(DateTime?), Required = true, Description = "The OK response")]
        [OpenApiResponseWithBody(verb: "GET",statusCode: HttpStatusCode.OK, contentType: "application/json", bodyType: typeof(NullableObjectModel), Description = "The OK response")]
        ...
        [OpenApiRequestBody(verb: "GET",contentType: "text/plain", bodyType: typeof(DateTimeOffset?), Required = true, Description = "The OK response")]
        [OpenApiResponseWithBody(verb: "GET",statusCode: HttpStatusCode.OK, contentType: "application/json", bodyType: typeof(NullableObjectModel), Description = "The OK response")]
