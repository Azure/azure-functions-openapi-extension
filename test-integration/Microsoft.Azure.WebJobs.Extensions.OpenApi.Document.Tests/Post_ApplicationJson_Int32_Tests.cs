...
{
    public class Post_ApplicationJson_Int32_Tests
    {
        [TestClass]
        [TestCategory(Constants.TestCategory)]
        public class Post_ApplicationJson_Int16_Tests
        {
            ...
            [DataTestMethod]
            [DataRow("/post-applicationjson-int32", "post", "200", "application/json", "int32ObjectModel")]
            ...
            [DataTestMethod]
            [DataRow("int32ObjectModel", "object")]
            ...
            [DataTestMethod]
            [DataRow("int32ObjectModel", "value", "integer")]
