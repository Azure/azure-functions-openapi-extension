...
{
    [TestClass]
    public class OpenApiTriggerRenderOpenApiDocumentFunctionProviderTests
    {
        [TestMethod]
        public void Given_Null_When_Anonymous_Instantiated_Then_It_Should_Throw_Exception()
        {
            Action action = () => new OpenApiTriggerRenderOpenApiDocumentAnonymousFunctionProvider(null);
        ...
        {
            Action action = () => new OpenApiTriggerRenderOpenApiDocumentUserFunctionProvider(null);
        ...
        {
            Action action = () => new OpenApiTriggerRenderOpenApiDocumentFunctionFunctionProvider(null);
        ...
        {
            Action action = () => new OpenApiTriggerRenderOpenApiDocumentSystemFunctionProvider(null);
        ...
        {
            Action action = () => new OpenApiTriggerRenderOpenApiDocumentAdminFunctionProvider(null);
