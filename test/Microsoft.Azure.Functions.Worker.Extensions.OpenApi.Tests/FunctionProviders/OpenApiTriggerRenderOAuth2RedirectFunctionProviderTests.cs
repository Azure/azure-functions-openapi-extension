...
{
    [TestClass]
    public class OpenApiTriggerRenderOAuth2RedirectFunctionProviderTests
    {
        [TestMethod]
        public void Given_Null_When_Anonymous_Instantiated_Then_It_Should_Throw_Exception()
        {
            Action action = () => new OpenApiTriggerRenderOAuth2RedirectAnonymousFunctionProvider(null);
        ...
        {
            Action action = () => new OpenApiTriggerRenderOAuth2RedirectUserFunctionProvider(null);
        ...
        {
            Action action = () => new OpenApiTriggerRenderOAuth2RedirectFunctionFunctionProvider(null);
        ...
        {
            Action action = () => new OpenApiTriggerRenderOAuth2RedirectSystemFunctionProvider(null);
        ...
        {
            Action action = () => new OpenApiTriggerRenderOAuth2RedirectAdminFunctionProvider(null);
