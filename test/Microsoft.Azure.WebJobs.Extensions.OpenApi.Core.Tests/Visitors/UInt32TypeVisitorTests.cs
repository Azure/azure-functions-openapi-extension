...
namespace Microsoft.Azure.WebJobs.Extensions.OpenApi.Core.Tests.Visitors
{
    ...
    public class UInt32TypeVisitorTests
    {
        ...
        {
            var result = this._visitor.ParameterVisit(typeof(uint), this._strategy, this._namespaceType);
        ...
        {
            var result = this._visitor.PayloadVisit(typeof(uint), this._strategy, this._namespaceType);
