...
namespace Microsoft.Azure.WebJobs.Extensions.OpenApi.Core.Tests.Visitors
{
    ...
    public class Int16EnumTypeVisitorTests
    {
        ...
        [DataTestMethod]
        [DataRow(typeof(FakeShortEnum), false)]
        ...
        [DataTestMethod]
        [DataRow(typeof(FakeShortEnum), true)]
        ...
        [DataTestMethod]
        [DataRow("integer", "int32", typeof(FakeShortEnum))]
        ...
        public void Given_Type_When_ParameterVisit_Invoked_Then_It_Should_Return_Result(string dataType, string dataFormat, Type enumType)
        {
            ...
            var result = this._visitor.ParameterVisit(typeof(FakeShortEnum), this._strategy, this._namespaceType);
        ...
        public void Given_Type_When_PayloadVisit_Invoked_Then_It_Should_Return_Result(string dataType, string dataFormat, Type enumType)
        {
            ...
            var result = this._visitor.PayloadVisit(typeof(FakeShortEnum), this._strategy, this._namespaceType);
