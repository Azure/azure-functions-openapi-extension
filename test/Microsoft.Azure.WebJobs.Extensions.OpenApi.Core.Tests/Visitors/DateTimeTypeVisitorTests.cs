...
namespace Microsoft.Azure.WebJobs.Extensions.OpenApi.Core.Tests.Visitors
{
    ...
    public class DateTimeTypeVisitorTests
    {
        ...
        {
            var result = this._visitor.ParameterVisit(typeof(DateTime), this._strategy, this._namespaceType);
        ...
        {
            var result = this._visitor.PayloadVisit(typeof(DateTime), this._strategy, this._namespaceType);
