...
namespace Microsoft.Azure.WebJobs.Extensions.OpenApi.Core.Tests.Visitors
{
    ...
    public class DecimalTypeVisitorTests
    {
        ...
        {
            var result = this._visitor.ParameterVisit(typeof(decimal), this._strategy, this._namespaceType);
        ...
        {
            var result = this._visitor.PayloadVisit(typeof(decimal), this._strategy, this._namespaceType);
