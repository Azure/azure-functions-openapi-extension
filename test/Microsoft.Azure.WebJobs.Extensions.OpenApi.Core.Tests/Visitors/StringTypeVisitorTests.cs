...
namespace Microsoft.Azure.WebJobs.Extensions.OpenApi.Core.Tests.Visitors
{
    ...
    public class StringTypeVisitorTests
    {
        ...
        {
            var result = this._visitor.ParameterVisit(typeof(string), this._strategy, this._namespaceType);
        ...
        {
            var result = this._visitor.PayloadVisit(typeof(string), this._strategy, this._namespaceType);
