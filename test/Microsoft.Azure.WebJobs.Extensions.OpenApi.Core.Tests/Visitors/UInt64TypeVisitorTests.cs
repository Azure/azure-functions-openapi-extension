...
namespace Microsoft.Azure.WebJobs.Extensions.OpenApi.Core.Tests.Visitors
{
    ...
    public class UInt64TypeVisitorTests
    {
        ...
        {
            var result = this._visitor.ParameterVisit(typeof(ulong), this._strategy, this._namespaceType);
        ...
        {
            var result = this._visitor.PayloadVisit(typeof(ulong), this._strategy, this._namespaceType);
