...
namespace Microsoft.Azure.WebJobs.Extensions.OpenApi.Core.Tests.Visitors
{
    ...
    public class Int16TypeVisitorTests
    {
        ...
        {
            var result = this._visitor.ParameterVisit(typeof(short), this._strategy);
        ...
        {
            var result = this._visitor.PayloadVisit(typeof(short), this._strategy, this._options.UseFullName);
