...
namespace Microsoft.Azure.WebJobs.Extensions.OpenApi.Core.Tests.Visitors
{
    ...
    public class SingleTypeVisitorTests
    {
        ...
        {
            var result = this._visitor.ParameterVisit(typeof(float), this._strategy, this._namespaceType);
        ...
        {
            var result = this._visitor.PayloadVisit(typeof(float), this._strategy, this._namespaceType);
