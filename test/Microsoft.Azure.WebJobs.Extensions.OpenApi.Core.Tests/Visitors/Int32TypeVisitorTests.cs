...
namespace Microsoft.Azure.WebJobs.Extensions.OpenApi.Core.Tests.Visitors
{
    ...
    public class Int32TypeVisitorTests
    {
        ...
        {
            var result = this._visitor.ParameterVisit(typeof(int), this._strategy, this._namespaceType);
        ...
        {
            var result = this._visitor.PayloadVisit(typeof(int), this._strategy, this._namespaceType);
