...
namespace Microsoft.Azure.WebJobs.Extensions.OpenApi.Core.Tests.Visitors
{
    ...
    public class DoubleTypeVisitorTests
    {
        ...
        {
            var result = this._visitor.ParameterVisit(typeof(double), this._strategy, this._namespaceType);
        ...
        {
            var result = this._visitor.PayloadVisit(typeof(double), this._strategy, this._namespaceType);
