...
namespace Microsoft.Azure.WebJobs.Extensions.OpenApi.Core.Tests.Visitors
{
    ...
    public class Int64TypeVisitorTests
    {
        ...
        {
            var result = this._visitor.ParameterVisit(typeof(long), this._strategy);
        ...
        {
            var result = this._visitor.PayloadVisit(typeof(long), this._strategy,this._options.UseFullName);
