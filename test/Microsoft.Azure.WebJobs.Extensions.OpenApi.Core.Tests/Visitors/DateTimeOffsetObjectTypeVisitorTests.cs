...
namespace Microsoft.Azure.WebJobs.Extensions.OpenApi.Core.Tests.Visitors
{
    ...
    public class DateTimeOffsetObjectTypeVisitorTests
    {
        ...
        {
            var result = this._visitor.ParameterVisit(typeof(DateTimeOffset), this._strategy, this._namespaceType);
        ...
        {
            var result = this._visitor.PayloadVisit(typeof(DateTimeOffset), this._strategy, this._namespaceType);
