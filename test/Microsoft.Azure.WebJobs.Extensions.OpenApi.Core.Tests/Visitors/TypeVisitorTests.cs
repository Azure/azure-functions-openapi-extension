...
namespace Microsoft.Azure.WebJobs.Extensions.OpenApi.Core.Tests.Visitors
{
    ...
    public class TypeVisitorTests
    {
        ...
        {
            var result = this._visitor.ParameterVisit(type, this._strategy, this._namespaceType);
        ...
        {
            var result = this._visitor.PayloadVisit(type, this._strategy, this._namespaceType);
