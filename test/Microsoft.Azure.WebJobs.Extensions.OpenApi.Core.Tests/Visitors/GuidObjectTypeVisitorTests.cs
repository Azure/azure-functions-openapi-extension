...
namespace Microsoft.Azure.WebJobs.Extensions.OpenApi.Core.Tests.Visitors
{
    ...
    public class GuidObjectTypeVisitorTests
    {
        ...
        {
            var result = this._visitor.ParameterVisit(typeof(Guid), this._strategy, this._namespaceType);
        ...
        {
            var result = this._visitor.PayloadVisit(typeof(Guid), this._strategy, this._namespaceType);
