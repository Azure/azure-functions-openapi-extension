...
namespace Microsoft.Azure.WebJobs.Extensions.OpenApi.Core.Tests.Visitors
{
    ...
    public class ListObjectTypeVisitorTests
    {
        ...
        [DataRow(typeof(List<string[]>), "array", null, "string[]", true, "fakeModel", 1)]
        ...
        [DataRow(typeof(List<string[]>), "array", null, "string[]", true)]
        ...
        [DataRow(typeof(List<string[]>), "array", null, "list_string", true, "string")]
