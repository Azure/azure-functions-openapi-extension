...
namespace Microsoft.Azure.WebJobs.Extensions.OpenApi.Core.Tests.Visitors
{
    ...
    public class ListObjectTypeVisitorTests
    {
        ...
        {
            var result = this._visitor.ParameterVisit(listType, this._strategy, this._namespaceType);
        ...
        {
            var result = this._visitor.PayloadVisit(listType, this._strategy, this._namespaceType);
