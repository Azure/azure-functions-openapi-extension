...
namespace Microsoft.Azure.WebJobs.Extensions.OpenApi.Core.Tests.Visitors
{
    ...
    public class UInt16TypeVisitorTests
    {
        ...
        {
            var result = this._visitor.ParameterVisit(typeof(ushort), this._strategy, this._namespaceType);
        ...
        {
            var result = this._visitor.PayloadVisit(typeof(ushort), this._strategy, this._namespaceType);
