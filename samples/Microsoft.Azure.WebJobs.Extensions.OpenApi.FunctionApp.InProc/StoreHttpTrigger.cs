...
namespace Microsoft.Azure.WebJobs.Extensions.OpenApi.FunctionApp.InProc
{
    public class StoreHttpTrigger
    {
        ...
        [OpenApiRequestBody(verb: "GET", contentType: "application/json", bodyType: typeof(Order), Required = true, Description = "Order placed for purchasing the pet")]
        [OpenApiResponseWithBody(verb: "GET", statusCode: HttpStatusCode.OK, contentType: "application/json", bodyType: typeof(Order), Summary = "successful operation", Description = "successful operation")]
        [OpenApiResponseWithoutBody(verb: "GET", statusCode: HttpStatusCode.BadRequest, Summary = "Invalid input", Description = "Invalid input")]
        ...
        [OpenApiParameter(verb: "GET", name: "orderId", In = ParameterLocation.Path, Required = true, Type = typeof(long), Summary = "ID of order that needs to be deleted", Description = "ID of order that needs to be deleted", Visibility = OpenApiVisibilityType.Important)]
        [OpenApiResponseWithoutBody(verb: "GET", statusCode: HttpStatusCode.BadRequest, Summary = "Invalid ID supplied", Description = "Invalid ID supplied")]
        [OpenApiResponseWithoutBody(verb: "GET", statusCode: HttpStatusCode.NotFound, Summary = "Order not found", Description = "Order not found")]
